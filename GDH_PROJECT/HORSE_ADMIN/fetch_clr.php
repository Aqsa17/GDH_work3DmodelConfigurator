                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="get_texture.php"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
			...
			while($row=mysqli_fetch_assoc($result)){
				?>
                               ...
                               <tr>
                               	...
                               	<td><?php echo $sno++?></td>
                               	<td><?php echo $row['shirt_clr'];?></td>
                               	<td><?php echo $row['shrt_mrkclr'];?></td>
                               	<td><?php echo $row['slv_clr'];?></td>
                               	<td><?php echo $row['short_clr'];?></td>
                         <?php echo "<td><a href='dlt_clr.php?id=".$row['id']."'><i class='fas fa-trash-alt' style='font-size:1.4vw'></i></a></td>"?>
                               	<?php
